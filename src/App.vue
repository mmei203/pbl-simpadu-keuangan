...
.sidebar { width: 230px; background: #1e3a8a; color: white; padding: 20px ; margin-bottom: -10px; margin-left: -10px; margin-top: -10px; display: flex; flex-direction: column; transition: 0.3s; flex-shrink: 0; }
